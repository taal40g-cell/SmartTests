...
class AntiCheatLog(Base):
    ...
    student_id = Column(Integer, ForeignKey("students.id"), nullable=False, index=True)
    subject_id = Column(Integer, ForeignKey("subjects.id"), nullable=False, index=True)
    question_id = Column(Integer, nullable=True, index=True)  # NEW

    school_id = Column(Integer, nullable=False, index=True)

    test_type = Column(String, nullable=False)  # objective / subjective
    event_type = Column(String, nullable=False)  # paste / tab_switch / window_blur / copy / etc
    ...
    __table_args__ = (
        ...
        Index("idx_question_event", "question_id", "event_type"),  # NEW
    )
